<template>
  <div class="w-full">
    <div class="flex items-top justify-between text-slate-500 text-sm" >
        <!-- Type -->   
        ...
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400" >{{rating}} out of 10</p>
        </div>
    </div>
  </div>
</template>
...
export default {
  ...
  props: ['rating', 'stops', 'duration', 'mode']
};
</script>